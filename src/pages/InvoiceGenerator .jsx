...
const salesData = [
  { id: 1, productName: "Mild Steel Rod", quantity: 25, price: 2805, date: "2024-09-21", customer: "Rahman Steel Works", unit: "pieces", description: "12mm x 12m Mild Steel Rod" },
  { id: 2, productName: "Galvanized Steel Sheet", quantity: 10, price: 4950, date: "2024-09-22", customer: "Metro Construction", unit: "sheets", description: "4ft x 8ft x 2mm Galvanized Steel Sheet" },
  { id: 3, productName: "Steel Angle Bar", quantity: 8, price: 2063, date: "2024-09-20", customer: "Building Solutions Ltd", unit: "pieces", description: "50mm x 50mm x 6m Steel Angle Bar" },
  { id: 4, productName: "Stainless Steel Plate", quantity: 2, price: 13750, date: "2024-09-19", customer: "Industrial Fabricators", unit: "plates", description: "3ft x 6ft x 5mm Stainless Steel Plate" },
  { id: 5, productName: "Steel Pipe", quantity: 5, price: 7205, date: "2024-09-18", customer: "Pipe & Fittings Co", unit: "pieces", description: "6 inch diameter x 6m Steel Pipe" }
];
...
const InvoiceGenerator = () => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Select a Sale to Generate Invoice</h2>
            </div>
            <div className="p-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Qty: {sale.quantity} {sale.unit} × ৳{sale.price.toLocaleString()}</p>
                          </div>
                          <div className="text-right">
                            <p className="font-semibold text-gray-900">Total: ৳{totals.total.toLocaleString()}</p>
                            <p className="text-sm text-gray-600">Subtotal: ৳{totals.subtotal.toLocaleString()}</p>
                            <p className="text-sm text-gray-600">VAT (15%): ৳{totals.vatAmount.toLocaleString()}</p>
                          </div>
                        </div>
                      </div>
                      <button
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* A4 Invoice Layout */}
      <div className="max-w-4xl mx-auto p-8 bg-white" style={{ minHeight: '297mm', width: '210mm' }}>
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <p>BIN: {companyInfo.bin} | VAT Reg: {companyInfo.vatReg}</p>
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-sm space-y-1">
                ...
                <p><span className="font-semibold">Sale Date:</span> {selectedSale.date}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="font-semibold text-gray-900">{selectedSale.customer}</p>
          ...
          <table className="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-4 text-center">{selectedSale.unit}</td>
                <td className="border border-gray-300 px-4 py-4 text-center">{selectedSale.quantity}</td>
                <td className="border border-gray-300 px-4 py-4 text-right">৳{selectedSale.price.toLocaleString()}</td>
                <td className="border border-gray-300 px-4 py-4 text-right font-semibold">৳{totals.subtotal.toLocaleString()}</td>
              </tr>
        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="font-semibold">Taka {numberToWords(Math.round(totals.total))} Only</p>
          </div>
        </div>
