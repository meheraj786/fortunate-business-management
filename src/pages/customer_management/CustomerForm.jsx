    ...
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.section className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="flex items-center justify-between p-6 bg-white border-b border-gray-200 rounded-t-lg">
              <div className="flex items-center space-x-4">
                <div className="p-3 bg-[#003b75] rounded-lg"><FileText className="w-6 h-6 text-white" /></div>
                <div><h3 className="text-lg font-semibold text-gray-900">Documents & LC Links</h3><p className="text-sm text-gray-600">Upload documents and link LCs</p></div>
              </div>
            </div>
            <div className="p-6">
              <div className="mb-8">
