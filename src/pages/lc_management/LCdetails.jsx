          ...
          <div className="lg:col-span-2 space-y-4">
            <CollapsibleCard title="Basic LC Information" icon={<FiFile />}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <DataField
                  label="LC Number"
                  value={lcData?.basic_info.lc_number}
                />
                <DataField
                  label="LC Opening Date"
                  value={lcData?.basic_info.lc_opening_date}
                />
                <DataField
                  label="Bank Name"
                  value={lcData?.basic_info.bank_name}
                />
                <DataField
                  label="Status"
                  value={<StatusBadge status={lcData?.basic_info.status} />}
                />
                <DataField
                  label="Supplier Name"
                  value={lcData?.basic_info.supplier_name}
                />
                <DataField
                  label="Supplier Country"
                  value={lcData?.basic_info.supplier_country}
                />
              </div>
            </CollapsibleCard>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <DataField
                  label="LC Amount (USD)"
                  value={financial_info.lc_amount_usd.toLocaleString()}
                />
                <DataField
                  label="Exchange Rate"
                ...
                <DataField
                  label="LC Amount (BDT)"
                  value={financial_info.lc_amount_bdt.toLocaleString()}
                />
                <DataField
                  label="LC Margin Paid (BDT)"
                  value={financial_info.lc_margin_paid_bdt.toLocaleString()}
                />
                <DataField
                  label="Bank Charges (BDT)"
                  value={financial_info.bank_charges_bdt.toLocaleString()}
                />
                <DataField
                  label="Insurance Cost (BDT)"
                  value={financial_info.insurance_cost_bdt.toLocaleString()}
                />
              </div>
            </CollapsibleCard>
            ...
            <CollapsibleCard title="Product Information" icon={<FiBox />}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <DataField
                  ...
                  value={product_info.unit_price_usd.toLocaleString()}
                />
                <DataField
                  label="Specification"
                  value={`Thickness: ${product_info.specification.thickness_mm}mm, Width: ${product_info.specification.width_mm}mm, Length: ${product_info.specification.length_mm}mm, Grade: ${product_info.specification.grade}`}
                />
                <DataField
                  label="Total Value (USD)"
                  value={product_info.total_value_usd.toLocaleString()}
                />
                <DataField
                  label="Quantity (Ton)"
                  value={product_info.quantity_ton}
                />
                <DataField
                  label="Total Value (BDT)"
                  value={product_info.total_value_bdt.toLocaleString()}
                />
              </div>
            </CollapsibleCard>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <DataField
                  ...
                  value={shipping_customs_info.customs_duty_bdt.toLocaleString()}
                />
                <DataField
                  label="VAT (BDT)"
                  value={shipping_customs_info.vat_bdt.toLocaleString()}
                />
                <DataField
                  label="AIT (BDT)"
                  value={shipping_customs_info.ait_bdt.toLocaleString()}
                />
                <DataField
                  label="Other Port Expenses (BDT)"
                  value={shipping_customs_info.other_port_expenses_bdt.toLocaleString()}
                />
              </div>
            </CollapsibleCard>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <DataField
                  ...
                  value={agent_transport_info.cnf_agent_commission_bdt.toLocaleString()}
                />
                <DataField
                  label="Indenting Agent Commission (BDT)"
                  value={agent_transport_info.indenting_agent_commission_bdt.toLocaleString()}
                />
                <DataField
                  label="Transport Cost (BDT)"
                  value={agent_transport_info.transport_cost_bdt.toLocaleString()}
                />
              </div>
            </CollapsibleCard>
          </div>
          ...
          <div className="space-y-4">
            <CollapsibleCard title="Cost Summary" icon={<FiPieChart />}>
              <div className="space-y-3">
                <DataField
                  label="LC Amount (BDT)"
                  value={cost_summary.lc_amount_bdt.toLocaleString()}
                />
                <DataField
                  label="Bank Charges (BDT)"
                  value={cost_summary.bank_charges_bdt.toLocaleString()}
                />
                <DataField
                  label="Insurance Cost (BDT)"
                  value={cost_summary.insurance_cost_bdt.toLocaleString()}
                />
                <DataField
                  label="Customs Total (BDT)"
                  value={cost_summary.customs_total_bdt.toLocaleString()}
                />
                <DataField
                  label="Agent Commission (BDT)"
                  value={cost_summary.agent_commission_bdt.toLocaleString()}
                />
                <DataField
                  label="Transport & Other (BDT)"
                  value={cost_summary.transport_other_bdt.toLocaleString()}
                />
                <hr className="my-4 border-gray-200" />
                <div className="flex justify-between items-center">
                  <p className="font-semibold">Total Cost (BDT)</p>
                  <p className="font-bold text-lg">
                    {cost_summary.total_lc_cost_bdt.toLocaleString()}
                  </p>
                </div>
                <DataField
                  label="Per Unit Landing Cost (BDT)"
                  value={cost_summary.per_unit_landing_cost_bdt.toLocaleString()}
                />
              </div>
            </CollapsibleCard>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2">
                    {lcData?.documents_notes.uploaded_documents.map(
                      (file, index) => (
                        <div
                          key={index}
                ...
                <DataField
                  label="Remarks"
                  value={lcData?.documents_notes.remarks}
                />
              </div>
            </CollapsibleCard>
          </div>
