...
export const PERMISSION_BUNDLES = {
  ...
  SALE_ITEM_UPDATE: ["SALE_VIEW_TABLE", "SALE_VIEW_DETAILS", "SALE_UPDATE"],
  ...
  PRODUCT_TRANSFER: ["PRODUCT_VIEW_TABLE", "PRODUCT_VIEW_DETAILS"],
